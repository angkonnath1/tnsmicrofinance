...
`;return f+=`
`,f}function c8(i){let s=s8(i);if(!s)return null;let u=`\`${s.parentDisplay}\``;return s.flexDirection&&(u+=`, flex-direction: \`${s.flexDirection}\``),s.gridCols&&(u+=`, grid-template-columns: \`${s.gridCols}\``),s.gap&&(u+=`, gap: \`${s.gap}\``),`Parent: ${u} (\`${s.parentSelector}\`)`}function Wb(i,s,u,f="standard"){if(i.length===0)return"";let h=[...i].sort((j,J)=>Math.abs(j.y-J.y)<20?j.x-J.x:j.y-J.y),y="";if(u?.blankCanvas?(y+=`## Wireframe: New Page
...
[data-agentation-theme=dark] .styles-module__label___J5mxE {
  color: rgba(255, 255, 255, 0.5);
}`,o7={container:"styles-module__container___w8eAF",label:"styles-module__label___J5mxE"};if(typeof document<"u"){let i=document.getElementById("feedback-tool-styles-checkbox-field-styles");i||(i=document.createElement("style"),i.id="feedback-tool-styles-checkbox-field-styles",document.head.appendChild(i)),i.textContent=n7}var ov=o7,lv=({className:i="",label:s,tooltip:u,checked:f,onChange:h,...y})=>{let k=(0,Cv.useId)();return(0,Ac.jsxs)("div",{className:`${ov.container} ${i}`,...y,children:[(0,Ac.jsx)(t7,{id:k,onChange:h,checked:f}),(0,Ac.jsx)("label",{className:ov.label,htmlFor:k,children:s}),u&&(0,Ac.jsx)(ss,{content:u})]})},l7=`@keyframes styles-module__cycleTextIn___VBNTi {
  0% {
    opacity: 0;
    transform: translateY(-6px);
  }
...
`+R)}if(ie)try{await navigator.clipboard.writeText(D)}catch{}E?.(D),Q(!0),rt(()=>Q(!1),2e3),Mt.autoClearAfterCopy&&rt(()=>pa(),500)},[J,Io,ae,ft,ct,K,ea,Dn,nt,Mt.outputDetail,qn,Mt.autoClearAfterCopy,pa,ie,E]),Ms=(0,U.useCallback)(async()=>{let b=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:nt,w=ev(J,b,Mt.outputDetail);if(!w&&ae.length===0&&!ft)return;if(w||(w=`## Page Feedback: ${b}
`),ae.length>0&&(w+=`
